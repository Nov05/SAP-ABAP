...
1. In Object-Oriented programming, factory design is used to abstract the process of creating objects, so the types of objects created can be specified at runtime.  
...
3. This program creats either a `Sales Quotation` object or a `Sales Order` object at runtime.
